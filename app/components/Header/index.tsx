  ...
  return (
    <header className="sticky w-full bg-white text-text text-lg font-bold tracking-wider  shadow-md top-0 left-0 h-28  z-50">
      ...
      <div className="flex justify-between w-full  px-4 py-5 items-center ">
        ...
        <nav className={`flex uppercase gap-4 text-sm h-[calc(100vh-7rem)] lg:h-auto  bg-white left-0 flex-col lg:flex-row font-semibold absolute lg:relative top-full w-[200px] ${!open&&"-translate-x-full lg:translate-x-0"} py-8 lg:py-0 lg:w-[40%] transition-all duration-300 px-4`}>
